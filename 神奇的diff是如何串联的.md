...
![image-20221128192900692](/Users/jianhang/Documents/learing/selfLearn/神奇的diff是如何串联的.assets/image-20221128192900692.png)
...
- 是否开启T值完整：就是在捞case的时候，该T值一定要存在于主流程中。
...
![image-20221128212917250](/Users/jianhang/Documents/learing/selfLearn/神奇的diff是如何串联的.assets/image-20221128212917250.png)
...
3. 针对特定的流程，还需要做特殊的参数转换，例如，submit的请求参数中，乘机人的姓名要加个随机字母，防止重复升单。detail的请求参数中，B参中token需要请求一个url得到，C参要使用上一个阶段（submit）的c参。
...
![image-20221128194330121](/Users/jianhang/Documents/learing/selfLearn/神奇的diff是如何串联的.assets/image-20221128194330121.png)
